...
import 'package:feedmeapp1/src/pages/sigin_page.dart';
//import 'package:food_app_flutter_zone/src/scoped-model/main_model.dart';
import 'package:feedmeapp1/src/widgets/show_dailog.dart';
...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Widget _buildConfirmPasswordTextField() {
    return TextFormField(
      ...
      obscureText: _toggleVisibility,
      onSaved: (String confirm_password) {
      ...
      validator: (String password) {
        ...
        if (password.isEmpty) {
          errorMessage = "Your confirm password is required";
        }
        return errorMessage;
      },
    );
